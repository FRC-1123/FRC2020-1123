...
public class ShooterSubsystem extends SubsystemBase {
  ...
  public ShooterSubsystem(CANSparkMax motorFixedA, CANSparkMax motorFixedB, DoubleSolenoid SolenoidA,
   DoubleSolenoid SolenoidB) {

    this.m_motors = new CANSparkMax[6];
    this.m_motorA = motorFixedA;
    this.m_motors[0] = motorFixedA;

    this.m_motorB = motorFixedA;
    this.m_motors[1] = motorFixedA;

    m_motorEncoders = new CANEncoder[6];
    m_motorFixedAEncoder = m_motorA.getEncoder();
    m_motorEncoders[0] = m_motorFixedAEncoder;

    m_motorFixedBEncoder = m_motorB.getEncoder();
...
//    this.m_motorA.set(Motor1Voltage);
//    this.m_motorB.set(Motor2Voltage);
