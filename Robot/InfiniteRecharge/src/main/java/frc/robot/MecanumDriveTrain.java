 ...
 */
public class MecanumDriveTrain extends RobotDriveBase implements Sendable, AutoCloseable {
   ...
   */
  public MecanumDriveTrain(SpeedController frontLeftMotor, SpeedController rearLeftMotor,
  ...
  public void driveCartesian(double ySpeed, double xSpeed, double zRotation, double maxThrottle, double gyroAngle) {
    ...
    ySpeed = applyDeadband(ySpeed, 0.2);
    xSpeed = MathUtil.clamp(xSpeed, -1.0, 1.0);
    xSpeed = applyDeadband(xSpeed, 0.2);
    zRotation = applyDeadband(zRotation, 0.2);
...
/**
  ...
  public void swivelCartesian(double ySpeed, double xSpeed, double zRotation, double maxThrottle) {
    ...
    zRotation = applyDeadband(zRotation, 0.2); //m_deadband
