 ...
 */
public class LowerGoalShootALotCommand extends CommandBase {
   ...
   */
  public LowerGoalShootALotCommand() {
  ...
  public boolean isFinished() {
    if(RobotContainer.getInstance().shooter.getNumberOfBallsFired() >= 10){
      return true;
    }
    return false;
  }
